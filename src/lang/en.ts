...
const source: Language = {
  ...
  'Tìm kiếm theo tên trang hoặc nhóm': 'Search by page or group name',
  'Không có nhóm': 'No groups',
  'Không có trang': 'No pages',
  'Không tìm thấy nhóm': 'No group found',
  'Không tìm thấy trang': 'No page found',
  ...
  'Thiết lập giao diện': 'Display setting',
  'Chat Nội bộ': 'Chat Internal',
  'Chat khách hàng': 'Customer chat',
  'Chung': 'General',
  'Chế độ': 'Mode',
  'Sáng': 'Day',
  'Tối': 'Night',
  ...
  'giờ trước': 'hours ago',
  'Biểu tượng trang': 'Page icon',
  'Biểu tượng nhân viên': 'Employee icon',
  'Biểu tượng nguồn trang': 'Page source icon',
  'Biểu tượng AI': 'AI icon',
  'Biểu tượng điện thoại': 'Phone icon',
  'Không hiện': 'Not display',
  'Không hiện thẻ': 'Not display card',
  'Biểu tượng màu': 'Icon color',
  'Chỉ hiện biểu tượng': 'Only display icon',
  'Đầy đủ': 'Full',
  'Hiện đầy đủ chữ và màu nền': 'Full text and background color',
  'Quay lại': 'Back',
  'Chọn tổ chức': 'Select organization',
  'Không tìm thấy tổ chức': 'No organization found',
  'Tìm kiếm theo tên và id tổ chức': 'Search by name and organization id',
  'Mới nhất': 'Newest',
  'Chưa đọc': 'Unread',
  'Chưa trả lời': 'Not replied',
  'Tự động': 'Auto',
  'Tổng số hội thoại': 'Total conversations',
  'Trung tâm hỗ trợ khách hàng': 'Support Center',
  'Cuộn lên đầu': 'Scroll to top',
  ...
  v1: {
    ...
    view: {
      ...
      download_app: {
        ...
        retion_mobile_title: 'Download Retion on your phone',
        retion_mobile_description:
          'A faster, more convenient experience that supports you anytime, anywhere.',
        scan_qr_to_install: 'Scan QR to install',
      },
    },
    component: {
      upload: {
