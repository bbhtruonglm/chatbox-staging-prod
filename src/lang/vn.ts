...
const source: Language = {
  ...
  'Thiết lập giao diện': 'Thiết lập giao diện',
  'Chat Nội bộ': 'Chat Nội bộ',
  'Thêm': 'Thêm',
  'Chat khách hàng': 'Chat khách hàng',
  'Chung': 'Chung',
  'Chế độ': 'Chế độ',
  'Sáng': 'Sáng',
  'Tối': 'Tối',
  ...
  'giờ trước': 'giờ trước',
  'Biểu tượng trang': 'Biểu tượng trang',
  'Biểu tượng nhân viên': 'Biểu tượng nhân viên',
  'Biểu tượng nguồn trang': 'Biểu tượng nguồn trang',
  'Biểu tượng AI': 'Biểu tượng AI',
  'Biểu tượng điện thoại': 'Biểu tượng điện thoại',
  'Không hiện': 'Không hiện',
  'Không hiện thẻ': 'Không hiện thẻ',
  'Biểu tượng màu': 'Biểu tượng màu',
  'Chỉ hiện biểu tượng': 'Chỉ hiện biểu tượng',
  'Đầy đủ': 'Đầy đủ',
  'Hiện đầy đủ chữ và màu nền': 'Hiện đầy đủ chữ và màu nền',
  'Quay lại': 'Quay lại',
  'Chọn tổ chức': 'Chọn tổ chức',
  'Không tìm thấy tổ chức': 'Không tìm thấy tổ chức',
  'Tìm kiếm theo tên và id tổ chức': 'Tìm kiếm theo tên và id tổ chức',
  'Cài đặt nhóm': 'Cài đặt nhóm',
  'Tìm kiếm theo tên trang hoặc nhóm': 'Tìm kiếm theo tên trang hoặc nhóm',
  'Không có nhóm': 'Không có nhóm',
  'Không có trang': 'Không có trang',
  'Không tìm thấy nhóm': 'Không tìm thấy nhóm',
  ...
  'Tự động': 'Tự động',
  'Tạo nhóm': 'Tạo nhóm',
  'Tổng số hội thoại': 'Tổng số hội thoại',
  'Trung tâm hỗ trợ khách hàng': 'Trung tâm hỗ trợ khách hàng',
  'Cuộn lên đầu': 'Cuộn lên đầu',
  ...
  v1: {
    ...
    view: {
      ...
      download_app: {
        ...
        retion_mobile_title: 'Tải Retion trên điện thoại',
        retion_mobile_description:
          'Trải nghiệm nhanh hơn, tiện hơn, hỗ trợ bạn mọi lúc, mọi nơi.',
        scan_qr_to_install: 'Quét QR để cài đặt',
      },
    },
    component: {
      upload: {
